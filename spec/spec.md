...
| 实时进度显示 | 7 个细粒度处理阶段 + 平滑动画 | P1 |
| 自动更新 | 支持 GitHub releases 自动检查和下载更新 | P2 |
| 跨平台支持 | macOS (ARM64) / Windows (x86-64) | P1 |
| Mac 安全书签 | 持久化文件夹访问权限，避免重复授权 | P1 |
| 集中式日志管理 | 统一日志收集、存储、查询和分析 | P2 |
...
| 图片处理 | Pillow (Python) | - |
| 压缩处理 | 7zip-min / adm-zip / node-unrar-js | - |
...
| 版本 | 日期 | 变更 |
|------|------|------|
| 1.1.1 | 2026-04-06 | 安全修复、代码质量改进、文档完善 |
| 1.1.0 | 2026-04-05 | Mac 安全书签机制、集中式日志管理、并行图片加载 |
...
| 1.1.3 | 2026-04-06 | 更新至 v1.1.1，添加安全书签和日志管理文档 |
