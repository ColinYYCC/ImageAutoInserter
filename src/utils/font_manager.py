...
class FontManager(QObject):
    ...
    def get_english_family(self) -> str:
        """
        获取英文字体系列名称
...
def get_global_font_manager():
    ...
    """
    if _FontManagerHolder._instance is None:
        _FontManagerHolder._instance = FontManager()
    return _FontManagerHolder._instance


# 便捷函数
def get_font(font_type: str = 'body', weight: str = 'normal', is_english: bool = False) -> QFont:
    """
    便捷获取字体
