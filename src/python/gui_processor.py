...
def process_excel_gui(excel_path: str, image_source: str):
    ...
    def on_progress(percent: float, action: str, total_rows: int = 0, current_row: int = 0) -> None:
        emitter.emit(
            percent=percent,
