...
export function createPathServiceTests(
  PathServiceClass: typeof import('@/core/platform/win32/WindowsPathService').WindowsPathService |
                   typeof import('@/core/platform/darwin/MacPathService').MacPathService,
...
export function createProcessServiceTests(
  ProcessServiceClass: typeof import('@/core/platform/win32/WindowsProcessService').WindowsProcessService |
                      typeof import('@/core/platform/darwin/MacProcessService').MacProcessService,
  platformName: 'win32' | 'darwin'
) {
...
export function createFileServiceTests(
  FileServiceClass: typeof import('@/core/platform/win32/WindowsFileService').WindowsFileService |
                    typeof import('@/core/platform/darwin/MacFileService').MacFileService,
  platformName: 'win32' | 'darwin'
) {
...
export function createSystemServiceTests(
  SystemServiceClass: typeof import('@/core/platform/win32/WindowsSystemService').WindowsSystemService |
                      typeof import('@/core/platform/darwin/MacSystemService').MacSystemService,
  platformName: 'win32' | 'darwin'
) {
